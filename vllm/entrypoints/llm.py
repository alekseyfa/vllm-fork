    ...
    def _run_engine(
        ...
        if profiling == True:
            ...
            lprofiler = profiler.profile(
                ...
                on_trace_ready=profiler.tensorboard_trace_handler('/tmp/vllm_logs', use_gzip=True), with_stack=True, with_modules=False, record_shapes=False, profile_memory=False)
            lprofiler.start()
