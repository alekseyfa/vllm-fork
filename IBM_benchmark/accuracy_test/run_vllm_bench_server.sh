...
if [[ $fp8 == "On" ]]; then
    QUANT_FLAGS="--quantization inc --kv_cache_dtype auto --weights_load_device cpu "
    case $selected_model in
        ...
        export QUANT_CONFIG=/root/tf/vllm_inp21/vllm3/vllm-fork/IBM_benchmark/accuracy/inc/config_maxabs_hw_quant.json
        ;;
    esac
fi
...
export export VLLM_PROMPT_SEQ_BUCKET_MAX=$input_len
