...
class PerformanceTest(HttpUser):
    ...
    def send_request(self):
        ...
        prompt = "Write a short story about squirrels"


        x_ = {}
        x_['model'] = 'mistralai/Mistral-Large-Instruct-2407'
        x_['prompt'] = 'Write a short story about squirrels'
        x_['max_tokens'] = 0
        x_['temperature'] = 0 
        x_['frequency_penalty'] = 0.8
        x_['ignore_eos'] = True
        x_['stream'] = True
        x_['stream_options'] = {"include_usage": "True"}
       # x = json.dumps(x_)
        #x = """{ 
